...
namespace _PrimeiroWebService.Controllers
{
    public class ItemController : SAPObjectBaseController
    {
        ...
        {
            double price = 0;
            var recordSet = (Recordset)ServerConnections.company.GetBusinessObject(BoObjectTypes.BoRecordset);
        ...
        public static ItemManagTypeEnum GetItemManagement(string itemCode)
        {
            ...
            Recordset rst = (Recordset)ServerConnections.company.GetBusinessObject(BoObjectTypes.BoRecordset);
        ...
        {
            Items oItem = (Items)ServerConnections.company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oItems);
            try
            {
